---
title: "Timeseries model of atmospheric CO2"
...
Bootstrapping can also be used to obtain prediction interval as the ones gained with traditional methods is often too narrow. We again use blocked bootstrapping.
...
write.table(future,file="future_bootstrap.txt") # keeps the rownames
```

```{r include=FALSE}
future <- read.table("future_bootstrap.txt",header=TRUE,row.names=1)
